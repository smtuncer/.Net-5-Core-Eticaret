...
namespace ETicaret.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary(ShoppingCartVM model)
        {
            ...
            ShoppingCartVM.OrderHeader.OrderStatus = Diger.Beklemede;
        ...
        private Payment PaymentProccess(ShoppingCartVM model)
        {
            Options options = new Options();
            options.ApiKey = "sandbox-FQ1Zoi0n661zxTlnvfZOjqhW7toke268";
            options.SecretKey = "sandbox-kccSQmAz52Pcl0WQmmP1cOwVO8Lgku9e";
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Doğrulama Emaili Hatalı");
            }
